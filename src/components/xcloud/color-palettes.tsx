    ...
    palettes: [
      {
        ...
        swatches: [
          ...
          { step: "800",  cssVar: "--primitive-blue-800", hex: "#0B4592" },
          { step: "900",  cssVar: "--primitive-blue-900", hex: "#08336D" },
          { step: "950",  cssVar: "--primitive-blue-950", hex: "#062349" },
          { step: "A100", cssVar: "--primitive-blue-950", hex: "#031124" },
        ],
      },
    ],
  },
    ...
    palettes: [
      {
        name: "Green",
        swatches: [
          { step: "25",   cssVar: "--primitive-green-25",   hex: "#COE4CD" },
          { step: "50",   cssVar: "--primitive-green-25",   hex: "#A5DCB9" },
          { step: "100",  cssVar: "--primitive-green-25",   hex: "#8BD4A6" },
          { step: "200",  cssVar: "--primitive-green-25",   hex: "#70CC93" },
          { step: "300",  cssVar: "--primitive-green-400",  hex: "#55C480" },
          ...
          { step: "800",  cssVar: "--primitive-green-700",  hex: "#18AD4F" },
          { step: "900",  cssVar: "--primitive-green-700",  hex: "#10813A" },
      ...
      },
      {
        ...
        swatches: [
          ...
          { step: "50",   cssVar: "--primitive-orange-25",   hex: "#FFDEBB" },
          { step: "100",  cssVar: "--primitive-orange-25",   hex: "#FFCE9A" },
          { step: "200",  cssVar: "--primitive-orange-25",   hex: "#FCB264" },
          { step: "300",  cssVar: "--primitive-orange-400",  hex: "#F5923F" },
          ...
          { step: "700",  cssVar: "--primitive-orange-600",  hex: "#C46C09" },
          { step: "800",  cssVar: "--primitive-orange-800",  hex: "#AB5C07" },
          { step: "900",  cssVar: "--primitive-orange-800",  hex: "#934E05" },
      ...
      },
      {
        ...
        swatches: [
          ...
          { step: "50",   cssVar: "--primitive-red-25",   hex: "#FBDCCB" },
          { step: "100",  cssVar: "--primitive-red-25",   hex: "#F7B0AD" },
          { step: "200",  cssVar: "--primitive-red-25",   hex: "#F3938C" },
          { step: "300",  cssVar: "--primitive-red-400",  hex: "#EF756E" },
          ...
          { step: "700",  cssVar: "--primitive-red-600",  hex: "#B53C30" },
          { step: "800",  cssVar: "--primitive-red-800",  hex: "#A0352A" },
          { step: "900",  cssVar: "--primitive-red-800",  hex: "#8B2D24" },
