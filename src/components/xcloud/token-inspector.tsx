...
const COLOR_TOKEN_MAP: Record<string, { name: string; category: string }> = {
  ...
  // ── Blue scale ────────────────────────────────────────────────
  "#DDECFF": { name: "--primitive-blue-25 / --surface-info (light)", category: "Blue" },
  "#BCD9FF": { name: "--primitive-blue-50", category: "Blue" },
  "#9AC6FF": { name: "--primitive-blue-100", category: "Blue" },
  "#79B3FF": { name: "--primitive-blue-200", category: "Blue" },
  "#57A0FF": { name: "--primitive-blue-300", category: "Blue" },
  "#368DFF": { name: "--primitive-blue-400 / --text-info (dark)", category: "Blue" },
  "#147AFF": { name: "--primitive-blue-500 / --primary / --brand", category: "Brand" },
  "#1169DB": { name: "--primitive-blue-600 / --primary-hover (light)", category: "Brand" },
  "#0E57B6": { name: "--primitive-blue-700 / --primary-hover (dark)", category: "Brand" },
  "#0B4692": { name: "--primitive-blue-800", category: "Blue" },
  "#09346D": { name: "--primitive-blue-900", category: "Blue" },
  "#062349": { name: "--primitive-blue-950 / --surface-info (dark)", category: "Blue" },

  // ── Light shades (light-mode neutrals) ────────────────────────
  "#FFFFFF": { name: "--primitive-ls-25 / --background / --card-elevated (light)", category: "Surface · Light" },
  "#FAFBFC": { name: "--primitive-ls-50 / --card / --popover (light)", category: "Surface · Light" },
  "#F2F5F7": { name: "--primitive-ls-100 / --secondary / --muted (light)", category: "Surface · Light" },
  "#EDF0F2": { name: "--primitive-ls-200 / --accent (light)", category: "Surface · Light" },
  "#E4E7EB": { name: "--primitive-ls-300 / --border (light)", category: "Border · Light" },
  "#8B939E": { name: "--primitive-ls-400 / --muted-foreground-em (light)", category: "Text · Light" },
  "#737985": { name: "--primitive-ls-500", category: "Text · Light" },
  "#535865": { name: "--primitive-ls-600 / --muted-foreground / --text-tertiary (light)", category: "Text · Light" },
  "#40444F": { name: "--primitive-ls-700 / --text-secondary (light)", category: "Text · Light" },
  "#2D313B": { name: "--primitive-ls-800", category: "Text · Light" },
  "#1F2128": { name: "--primitive-ls-900 / --foreground (light)", category: "Text · Light" },
  "#181A1F": { name: "--primitive-ls-950", category: "Text · Light" },

  // ── Dark shades (dark-mode neutrals) ──────────────────────────
  "#E9EBED": { name: "--primitive-ds-25 / --foreground (dark)", category: "Text · Dark" },
  "#CBCFD5": { name: "--primitive-ds-50 / --text-secondary (dark)", category: "Text · Dark" },
  "#B0B6BF": { name: "--primitive-ds-100", category: "Text · Dark" },
  "#89909D": { name: "--primitive-ds-200 / --muted-foreground (dark)", category: "Text · Dark" },
  "#737A85": { name: "--primitive-ds-300", category: "Text · Dark" },
  "#515A67": { name: "--primitive-ds-400", category: "Text · Dark" },
  "#373E4A": { name: "--primitive-ds-500 / --border (dark)", category: "Border · Dark" },
  "#333842": { name: "--primitive-ds-600 / --border-secondary (dark)", category: "Border · Dark" },
  "#292E39": { name: "--primitive-ds-700 / --muted / --popover (dark)", category: "Surface · Dark" },
  "#23272D": { name: "--primitive-ds-800 / --card (dark)", category: "Surface · Dark" },
  "#1F2328": { name: "--primitive-ds-900 / --background (dark)", category: "Surface · Dark" },
  "#181B1F": { name: "--primitive-ds-950", category: "Surface · Dark" },

  // ── Green (success) ───────────────────────────────────────────
  "#C0E4CD": { name: "--primitive-green-25 / --surface-success (light)", category: "Status · Success" },
  "#3ABB6D": { name: "--primitive-green-400 / --text-success (dark)", category: "Status · Success" },
  "#1DC35A": { name: "--primitive-green-500", category: "Status · Success" },
  "#18AD4F": { name: "--primitive-green-600 / --success", category: "Status · Success" },
  "#149744": { name: "--primitive-green-700 / --text-success (light)", category: "Status · Success" },
  "#1E3F30": { name: "--primitive-green-A100 / --surface-success (dark)", category: "Status · Success" },

  // ── Orange (warning) ──────────────────────────────────────────
  "#FEEEDC": { name: "--primitive-orange-25 / --surface-warning (light)", category: "Status · Warning" },
  "#F47C18": { name: "--primitive-orange-400", category: "Status · Warning" },
  "#F2870D": { name: "--primitive-orange-500 / --warning", category: "Status · Warning" },
  "#DB790B": { name: "--primitive-orange-600 / --text-warning (light)", category: "Status · Warning" },
  "#AB5C07": { name: "--primitive-orange-800", category: "Status · Warning" },
  "#633101": { name: "--primitive-orange-A100 / --surface-warning (dark)", category: "Status · Warning" },

  // ── Red (destructive / error) ─────────────────────────────────
  "#FDE9E6": { name: "--primitive-red-25 / --surface-error (light)", category: "Status · Error" },
  "#EB5851": { name: "--primitive-red-400 / --text-error (dark)", category: "Status · Error" },
  "#E24C3C": { name: "--primitive-red-500 / --destructive", category: "Status · Error" },
  "#CC4436": { name: "--primitive-red-600 / --text-error (light)", category: "Status · Error" },
  "#A0352A": { name: "--primitive-red-800", category: "Status · Error" },
  "#5D1F18": { name: "--primitive-red-A100 / --surface-error (dark)", category: "Status · Error" },
}
